...
var (
	FrontierBlockReward           = big.NewInt(900e+12) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward          = big.NewInt(900e+12) // Block reward in wei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = big.NewInt(900e+12) // Block reward in wei for successfully mining a block upward from Constantinople
